...
-								Includes									 -
-----------------------------------------------------------------------------*/
#include <stdio.h> //included the standard input/output library
#include <stdlib.h> //included the standard library
#include <time.h>
...
-----------------------------------------------------------------------------*/
void hoo();
void print_face(int selection); // added a prototype for the print_face function
